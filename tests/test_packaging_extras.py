...
def test_server_extra_stays_vision_runtime_light() -> None:
    ...
    assert "abstractvision>=0.3.14" in vision_block
    assert "abstractvision[huggingface]>=0.3.14" in vision_diffusers_block
    assert "abstractvision[sdcpp]>=0.3.14" in vision_sdcpp_block
    assert "abstractvision[local]>=0.3.14" in vision_local_block
    ...
    assert "abstractvision[all-apple]>=0.3.14" in all_apple_block
    ...
    assert "abstractvision[all-gpu]>=0.3.14" in all_gpu_block
    ...
    assert "abstractvision>=0.3.14" in full_dev_block
